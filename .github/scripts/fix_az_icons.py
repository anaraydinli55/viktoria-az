...
NEW_WA_SVG = (
    ...
    'm8.413-18.297A11.815 11.815 0 0012.05 0C5.414 0 .004 5.411.001 12.045a11.811 11.811 '
    '0 001.592 5.96L0 24l6.117-1.605a11.772 11.772 0 005.925 1.585h.005c6.637 0 '
    '12.046-5.411 12.049-12.047a11.814 11.814 0 00-3.576-8.504"/>'
    '</svg>'
)
...
def fix_az_page(html):
    ...
    html = re.sub(
        r'(<a[^>]+class=["\'][^"\']*float-wa[^"\']*["\'][^>]*>)\s*<svg.*?</svg>\s*(</a>)',
        r'\1' + NEW_WA_SVG + r'\2',
        html, flags=re.DOTALL
    )
