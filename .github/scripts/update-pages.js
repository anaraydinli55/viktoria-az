...
function updateFile(filePath, lang, color, slug, index) {
    ...
    content = content.replace(/name="twitter:title"\s+content=".*?"/i, `name="twitter:title" content="${title}"`);
    content = content.replace(/name="twitter:description"\s+content=".*?"/i, `name="twitter:description" content="${desc}"`);
